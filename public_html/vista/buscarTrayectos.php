    ...
    <body>
        ...
        <div align="center" ng-controller="mainController">
            ...
            <strong class="strindex">Aquí se muestra una lista de los trayectos a los que te puedes agregar o puedes mostrar la informacion del conductor.
                ...
                <img src="../img/acceptbutton.png" alt="" width="15px" height="15px"/> manda la peticion al conductor de que te quieres agregar a dicho trayecto. La página también dispone de un buscador en el que podras filtrar tu búsqueda según tus preferencias, ya sea por origen, destino, fecha u hora, plazas, paradas, etc....
                    ...
                    <table class="tabla-buscar"> 
                        ...
                        <tr ng-repeat="item in lista| filter:TEXTObusqueda">
                            ...
                            <td class="peque"><span> <img src="../img/infobutton.png" class="txiki" style="cursor:pointer;" ng-click='infor($index, item)' alt="" >&nbsp;
                                    <span class="peque"><img src="../img/acceptbutton.png" class="txiki" style="cursor:pointer;" ng-click='peti($index, item.id)' alt="" ></span> </td>
                        </tr>                   
                    </table>                                  
                </div>
            </div>
